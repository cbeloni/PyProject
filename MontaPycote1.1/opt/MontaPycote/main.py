...
os.system('cp /opt/MontaPycote/ALL_ERRORS.sql Chamado_'+sChamado)
os.system('cp /opt/MontaPycote/compila2.sql Chamado_'+sChamado)
os.system('cp /opt/MontaPycote/LF_TAB_LOG_PACOTE_CREATE.SQL Chamado_' + sChamado)
